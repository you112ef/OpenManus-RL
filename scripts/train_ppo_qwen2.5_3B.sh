...
export CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-1,2,3,4,5,6,7} # change your GPU ID here, if change the number of GPUs, please also change the number in the line 330
NUM_GPUS=8
...
NUM_SERVERS=5 # Default number of servers
BASE_PORT_OVERRIDE=""
DATA_DIR_OVERRIDE=""
EXP_NAME_SUFFIX=""
